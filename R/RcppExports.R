...
rolog_init <- function(home=system.file("swipl/lib/swipl-7.5.14", package="rolog"), prc=file.path(home, "boot64.prc"))
{
...
{
  .Call('rolog_rolog_query', enc2native(predicate), enc2native(call), PACKAGE='rolog')
}
